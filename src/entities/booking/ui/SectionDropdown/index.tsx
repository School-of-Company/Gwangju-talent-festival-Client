    ...
    <>
      ...
      <div className={cn("relative", className)}>
        <button
          ...
          className={cn(
            "flex items-center justify-between w-full px-6 py-3 text-body2b transition-colors duration-200",
            "min-w-[200px] min-h-[48px] border-1 rounded-md",
            selectedSection
              ? "border-main-600 bg-main-50"
              : "border-gray-200 bg-white text-gray-500 hover:border-main-300"
          )}
        >
          <span className="text-caption2b mx-4 font-bold">
            {selectedSection || "선택하기"}
          </span>
          <svg 
            className={cn(
